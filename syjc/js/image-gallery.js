...
class ImageGallery {
    ...
    loadGallery(folderId, containerId = 'masonry') {
        ...
        if (!images || !Array.isArray(images)) {
            console.error(`Manifest ${manifestVar} not found. Make sure to load the manifest script first.`);
            console.error(`Available manifests:`, Object.keys(window).filter(k => k.startsWith('MANIFEST_')));
            return;
        }
